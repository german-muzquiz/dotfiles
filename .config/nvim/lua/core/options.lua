...
vim.opt.sidescrolloff = 50                             -- minimal number of screen columns to keep to the left and right of the cursor if wrap is `false`
...
vim.opt.breakindent = false  			       -- don't break lines automatically
vim.opt.tw = 0              			       -- don't break lines automatically
...
vim.opt.foldlevel = 2
vim.opt.so = 999
vim.opt.autowriteall = true          		       -- write all changes when leaving buffer
vim.opt.fillchars = {
