    ...
    config = function()
        ...
        local on_attach = function(_, bufnr)
            ...
            keymap("n", "gD", vim.lsp.buf.declaration,
                { silent = true, buffer = bufnr, desc = "LSP - Jumps to the declaration of the symbol under the cursor." })
            ...
            keymap("n", "dl", vim.diagnostic.open_float,
                { silent = true, buffer = bufnr, desc = "LSP - Show diagnostics in a floating window." })
            keymap("n", "d]", vim.diagnostic.goto_next,
                { silent = true, buffer = bufnr, desc = "LSP - Move to the next diagnostic." })
            keymap("n", "d[", vim.diagnostic.goto_prev,
                { silent = true, buffer = bufnr, desc = "LSP - Move to the previous diagnostic in the current buffer." })
            ...
            keymap("n", "<leader>lr", vim.lsp.buf.rename,
                { silent = true, buffer = bufnr, desc = "LSP - Renames all references to the symbol under the cursor." })
            ...
            keymap("n", "<leader>lq", vim.diagnostic.setloclist,
                { silent = true, buffer = bufnr, desc = "LSP - Add buffer diagnostics to the location list." })
            keymap("n", "<leader>li", vim.cmd.LspInfo,
                { silent = true, buffer = bufnr, desc = "LSP - Display information about running language servers." })
            keymap("n", "<leader>r", vim.lsp.buf.format,
                { silent = true, buffer = bufnr, desc = "LSP - Format current buffer." })
        end
