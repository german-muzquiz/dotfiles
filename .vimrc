...
set wildmenu
set wildignore+=*/.git/*,*/.hg/*,*/.svn/*,*/.idea/*,*/.DS_Store,*/node_modules/*,*/target/*,*/*.jar,*/*.class,*/*.zip,*/*.tar,*/*.gz,*/*.war,*/bower_components/*,*/dist/*,*/.terraform/*,*/.venv/*,*/.mypy_cache/*,*/.pytest_cache/*,*/venv/*,*/__pycache__/*
...
" ---------------------------------- FZF ----------------------------------
let s:rg_ignore_globs = '--glob "!**/.git/*" --glob "!**/.venv/*" --glob "!**/venv/*" --glob "!**/node_modules/*" --glob "!**/.mypy_cache/*" --glob "!**/.idea/*" --glob "!**/.DS_Store/*" --glob "!**/target/*" --glob "!**/.terraform/*" --glob "!**/__pycache__/*" --glob "!**/.env/*"'
